...
public static class TypeScriptSseGenerator
{
    ...
    /// <param name="clientImport">Import path for generated client types (default: "./generated-client")</param>
        ...
        string clientImport = "./generated-client")
    {
        ...
        var eventTypes = endpoints.Select(e => e.EventType).Distinct().OrderBy(x => x).ToList();
        var typescript = GenerateTypeScript(endpoints, eventTypes, baseUrlImport, clientImport);
        ...
        string clientImport)
    {
        ...
        sb.AppendLine($"}} from '{clientImport}';");
        sb.AppendLine();

        // Header comment
        sb.AppendLine("/**");
        sb.AppendLine(" * Auto-generated EventSource client");
        sb.AppendLine(" * Generated by EventSourceGen NuGet package");
